...
public class ProductService {
	...
	public List<Product> getAllProductsOrderedAndPaginated(ProductResourceBeanParam beanParam){
		...
		List<Product> productListPaginated =
				getAllProductsOrdered(beanParam.getOrderByQueryParam(), productList);		
	...
	public List<Product> getAllProductsOrdered(String orderByField, List<Product> productList){
		...
		Comparator<Product> compScore = (p1, p2) -> Integer.valueOf(p1.getScore()).compareTo(Integer.valueOf(p2.getScore()));
