	...
	public synchronized User getByField(String fieldName, String fieldValue) {		
		...
		try {
			...
			User User = entityManager
					.createQuery("select user from User as user where user." + fieldName + " = \'" + fieldValue + "\'", User.class)
					.getSingleResult();
			return User;
			...
			LOGGER.debug("There was an error fetching the results of User by field {} equals to {}", fieldName, fieldValue);
			ex.printStackTrace();
